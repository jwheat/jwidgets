<?php
    ...
    <link type="text/css" rel="stylesheet" href="/site/custom_scripts/mcnews/mcnews-mobile.css">
...
<!--
            <div class="filters">
                ...
                <div class="clear"></div>
                <p>Choose categories below that interest you the most, then bookmark the page to store your news preferences.</p>
                
                    <?php print $filter_category; ?>

                <div class="refine-search" style='display:none;'>
                    <h4>Refine search:</h4>
                        <div id='block_refine'>
                        </div>
                </div>
...
<?php
        ...
        <div id="main">
            <div class="tabs">
                <ul>
                    <li><a href="http://www.messiah.edu/news">News</a></li>
                    <li class="active"><a href="http://www.messiah.edu/events">Events</a></li>
