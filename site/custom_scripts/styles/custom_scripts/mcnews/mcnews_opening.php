<?php
    ...
    $trackedURLs = [];
    $hideColumn = true; // (boolean) hideColumn();
    ...
    <link type="text/css" rel="stylesheet" href="/site/custom_scripts/mcnews/mcnews.css">
        ...
        if (($script == 'home_info.php' || $script == 'documents.php') && defined('CUSTOM_BANNER_IMAGE_SEASONS') && isset($homepage) && in_array(mb_strtolower($STYLESHEET), explode(',', mb_strtolower(CUSTOM_BANNER_IMAGE_SEASONS)))) {
            if (defined('CUSTOM_BANNER_IMAGE_PATH') && defined('CUSTOM_BANNER_IMAGE_DEFAULT_FOLDER')) {
                ...
                if ($homepageID > 0) {
                    ...
                    // check for .html file in html directory
                    $bannerHTMLFilenames = getFilenamesInDir($_SERVER['DOCUMENT_ROOT'] . $bannerImagePath . '/html');
...
<div class="visual-block">
    <?php 
        if (sizeof($bannerHTMLFilenames) > 0) {
            $hero_html = file_get_contents('/var/www/jadu/public_html/' . $bannerImagePath . '/html/' . $bannerHTMLFilenames[0]);
            print $hero_html;
            $show_title = false;
        } else {
            $show_title = true;
...
<header class="heading">
    <div class="holder">
<!-- TITLE -->
       <h1 class="page-title"><span><?php print encodeHtml($MAST_HEADING); ?></span></h1>
<!-- TITLE END -->
    </div>
...
<?php
        ...
        <div id="main">
            <div class="tabs">
                <ul>
                    <li class="active"><a href="http://www.messiah.edu/news">News</a></li>
                    <li><a href="http://www.messiah.edu/events">Events</a></li>
                    <li><a href="http://www.messiah.edu/social">Social Media</a></li>
                    <li><a href="http://www.messiah.edu/for-the-media">For the Media</a></li>
                </ul>
            </div>
...
<!-- googleon: all -->
        ...
        <div class="filterbox">
            <div class="search-form">
                <form action="https://www.messiah.edu/homepage/2727/" method="get">
                    <fieldset>
                        <input class="btn-submit" value="GO" type="submit">
                        <div class="input">
                            <label for="search-site" class="visuallyHidden">Search</label>
                            <input class="txt " size="18" maxlength="40" name="q" id="search" value="Search" type="text">
                        </div>
                    </fieldset>
                </form>
            </div>
            ...
            <div class="filters">
                ...
                <input class="switchbox" id="mobile-filters" type="checkbox">
                <label class="switch toggleIcon marker icon-chevron" onclick="" for="mobile-filters"></label>
                <div class="clear"></div>
                <p>Use the categories below to filter the news articles.</p>
                <div class="filter-list">
                    <ul>
                        <?php print $filter_category; ?>
                    </ul>
                    <!-- REFINE SEARCH -->
                    <div id='block_refine' style="display:none;">
