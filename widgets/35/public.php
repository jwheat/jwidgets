...
<div class="mpw-container"> 
 <?php if ($img_src != "") { ?>
        <img class="left-image" src="/images/<?php print $img_src;?>" alt="<?php print $param_image_alttext;?>" >
    <?php } ?>
<div class="mpw-right">
    <?php if ($param_heading != "") { ?>
        <h3><?php print $param_heading;?></h3>
    <?php } ?>

    <?php if ($param_subheading != "") { ?>
        <h4><?php print $param_subheading;?></h4>
    <?php } ?>

    <?php if ($content != "") { ?>
        <div class="mpw-text"><?php print $content;?></div>
    <?php } ?>
