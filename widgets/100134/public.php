<?php
    ...
    $customEventsTitle = (strpos($rawCustomEventsTitle, 'CUSTOM_EVENTS_TITLE') !== false || empty($rawCustomEventsTitle)) ? 'Upcoming open house events' : $rawCustomEventsTitle;
...
<div class="messiah-accordion">
    <button class="accordion acc"><span class="btn-text"><?php print $customEventsTitle; ?></span></button>
    <div class="panel">
