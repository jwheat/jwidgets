<table class="form_table" id="lb_widget_content">
    ...
    <tr class="generic_action">
        ...
        <td class="data_cell">
            <img id="img_srci" class="img_preview" src="<?php print $SECURE_JADU_PATH; ?>/images/no_image.gif" width="100%" />
        </td>
    </tr>
    <tr>
        <td class="label_cell">Click through link</td>
        <td class="data_cell">
            <input id="link_href" value="" size="12" type="text" class="field" />
        </td>
    </tr>
    <tr>
        <td class="label_cell">Link Text</td>
        <td class="data_cell">
            <input id="link_text" value="" size="12" type="text" class="field" />
        </td>
    </tr>
    </tbody>
</table>
