...
<link type="text/css" rel="stylesheet" href="<?php echo $folder; ?>mc-programs.css?version=1"/>
...
<div class="editor">
    <div id="full-view">
        ...
        <div class="search-box">
            <p class="desktop">
                <strong>Finding the right major can be difficult.</strong>
                Search by keywords or interests to explore which of Messiahâs 80+ academic programs would be a good fit for you.
            </p>
        ...
        <div class="mobile-interests">
            ...
            <select class="area-of-interest">
                ...
                <option value="Business-Consultion">Business/Consultion</option>
            ...
            <table class="program-table">
                ...
                <thead>
                    <td class="tabs" colspan="7">
                        ...
                        <a href="index.php?grad=1"><span id="graduate" class="tab">Graduate Programs</span></a>
                        <span class="view-buttons">
                            <span class="view-title">Group by<br>categories</span>
                ...
                <tbody>
                    ...
                    <tr class="filters">
                        <td colspan="7" class="undergraduate-filters" style="display:none">
                            ...
                            <span class="filter <?php if ($programsPage) { ?>filter-programs cursor-pointer<?php } ?> prepro" data-filter="prepro"><span class="badge"></span> PRE PROFESSIONAL</span>
                            <span class="filter <?php if ($programsPage) { ?>filter-programs cursor-pointer<?php } ?> dual-degree" data-filter="dual"><span class="badge"></span> DUAL DEGREE</span>
    ...
    <div id="search-view" style="display:none">
        <div class="no-search-results">
            <div class="sorry">
                <h2>Please try againâ¦</h2>
                <p>SEARCH TIP: Try using interest keywords like âaccountingâ or âmathâ rather than a 
                potential job title (âaccountantâ) to find more programs! And remember, you can always 
                visit a full list of our <a href="http://www.messiah.edu/majors-minors-programs">undergraduate programs</a>
                 and <a href="http://www.messiah.edu/info/20436/degrees">graduate programs</a>.</p>
            </div>                                    
        </div>
                ...
                <tbody>
                    <tr class="filters">
                        <td colspan="7" class="undergraduate-filters" style="display:none">
                            ...
                            <span class="filter prepro"><span class="badge"></span> PRE PROFESSIONAL</span>
                            <span class="filter dual-degree"><span class="badge"></span> DUAL DEGREE</span>
        ...
        <div class="search-box bottom">
              <p class="intro"><span>Didnât find exactly what you were looking for?</span> Try another related keyword, or another format of that keyword, and search again. With more than 80 majors, minors and concentrations, itâs likely we have a program of interest to you!</p>
...
<div class="frame interests" id="interests" style="display: none">
    <div class="info-box bg-info">
        ...
        <form>
            <input class="category-filter" type="radio" name="interest" value=""><span class="category-filter-text">All</span><br>
...
<script id="programs-template" type="text/x-jQuery-tmpl">
    <tr class="program-line {{if (expanded) }}expanded{{/if}}">
        ...
        <td>{{if ((preprofessional_programs == 'Yes') || (preprofessional_programs == 'yes')) }}<span class="show-tooltip prepro"><span class="badge"></span></span>{{/if}}</td>
...
<script id="peek-template" type="text/x-jQuery-tmpl">
    <div class="peek">
        ...
        <div class="peek-img">
            {{if thumbnail_peek != '' }}
            <img id="peek-large-image" src="http://www.messiah.edu/images/${thumbnail_peek}">
            {{/if}}
        </div>
        <div class="peek-content">
            ...
            <a class="peek-button" href="${program_url}" target="_blank">Visit Page</a>
        </div>
...
<script id="peek-related-programs-template" type="text/x-jQuery-tmpl">
    <div class="related-single open-subpeek" data-index="${index}">
        <div class="single-img">
            {{if (thumbnail_small == '') }}
            <img src="http://www.messiah.edu/site/custom_scripts/images/default_thumbnail.png"/>
            {{else}}
            <img src="http://www.messiah.edu/images/${thumbnail_small}"/>
            {{/if}}
        </div>
        <div class="info">
            <h4>${program_name}</h4>
...
<script id="subpeek-template" type="text/x-jQuery-tmpl">
    <div class="subpeek">
        ...
        <div class="peek-img">
            <img id="subpeek-large-image" src="http://www.messiah.edu/images/${thumbnail_peek}">
        </div>
        <div class="peek-content">
            <h2 class="peek-title">${program_name}
                {{each degree_types}}
...
<script type="text/javascript" src="<?php echo $folder; ?>mc-programs.js?v=2"></script>
