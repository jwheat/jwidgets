...
?>
   ...
   <div class="athletics" id="continue-exploring">
        <div class="wrapper content">
            <h3><?php print $nav_widget_title;?></h3
...
?>
                ...
                <a class="explore-button" href="<?php if (strpos($widgetLink[1], 'http://') !== 0 && strpos($widgetLink[1], 'https://') !== 0) { print 'http://'; } print encodeHtml($widgetLink[1]); ?>"><?php print encodeHtml($widgetLink[0]); ?></a>
<?php
        }
?>
