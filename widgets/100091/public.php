<?php
    ...
    $param_buttontext_1 = "link 1";
    $param_buttonlink_1 = "#";
    $param_buttontext_2 = "link 2";
    $param_buttonlink_2 = "#";
...
?>
    ...
    <div class="athletics" id="game-day" data-parallax="scroll" data-image-src="<?php echo $folder; ?>img/athletics/game-day-bg.jpg">
        <div class="wrapper content">
            ...
            <div class="flexbox">
                <div class="col-50">
                    ...
                    <p>
                        <a href="<?php print $param_buttonlink_1;?>" class="ath-button"><?php print $param_buttontext_1;?></a>
                        <a href="<?php print $param_buttonlink_2;?>" class="ath-button"><?php print $param_buttontext_2;?></a>
                    </p>
                </div>
        ...
        <div class="wrapper content center">
            <h3><span>And the crowd goes wild…</span></h3>
            <div class="ath-slider">
                ...
                <?php if ( !empty($param_quote_1_title) ) { ?>
                    ...
                    <div class="ath-slide">
                        <img src="/images/<?php echo $param_quote_1_image; ?>" alt="">
                        <span><?php echo $param_quote_1_title; ?></span>
                        <div class="ath-slide-info">
                            <p>“<?php echo $param_quote_1_quote; ?>”</p>
                        </div>
                    </div>

                <?php } ?>
                <?php if ( !empty($param_quote_2_title) ) { ?>

                    <div class="ath-slide">
                        <img src="/images/<?php echo $param_quote_2_image; ?>" alt="">
                        <span><?php echo $param_quote_2_title; ?></span>
                        <div class="ath-slide-info">
                            <p>“<?php echo $param_quote_2_quote; ?>”</p>
                        </div>
                    </div>

                <?php } ?>
                <?php if ( !empty($param_quote_3_title) ) { ?>

                    <div class="ath-slide">
                        <img src="/images/<?php echo $param_quote_3_image; ?>" alt="">
                        <span><?php echo $param_quote_3_title; ?></span>
                        <div class="ath-slide-info">
                            <p>“<?php echo $param_quote_3_quote; ?>”</p>
                        </div>
                    </div>

                <?php } ?>
                <?php if ( !empty($param_quote_4_title) ) { ?>

                    <div class="ath-slide">
                        <img src="/images/<?php echo $param_quote_4_image; ?>" alt="">
                        <span><?php echo $param_quote_4_title; ?></span>
                        <div class="ath-slide-info">
                            <p>“<?php echo $param_quote_4_quote; ?>”</p>
                        </div>
                    </div>

                <?php } ?>
                <?php if ( !empty($param_quote_5_title) ) { ?>

                <div class="ath-slide">
                    <img src="/images/<?php echo $param_quote_5_image; ?>" alt="">
                    <span><?php echo $param_quote_5_title; ?></span>
                    <div class="ath-slide-info">
                        <p>“<?php echo $param_quote_5_quote; ?>”</p>
                    </div>
                </div>

                <?php } ?>
                <?php if ( !empty($param_quote_6_title) ) { ?>

                    <div class="ath-slide">
                        <img src="/images/<?php echo $param_quote_6_image; ?>" alt="">
                        <span><?php echo $param_quote_6_title; ?></span>
                        <div class="ath-slide-info">
