...
function addWidgetImage ()
{
    ...
    $("image2_carousel_image").value = "";
    $("image2_carousel_imagei").src= "../images/no_image.gif";
    ...
    $("image_carousel_button_hide").value="";
...
function editWidgetImage (widgetImageID)
{
    ...
    if (widgetImages[currentImageEdit][1] != null) {
        $("image2_carousel_image").value = widgetImages[currentImageEdit][1];
    }
    if (widgetImages[currentImageEdit][1] != null) {
        $("image2_carousel_imagei").src = 'http://'+$('DOMAIN').value+'/images/'+widgetImages[currentImageEdit][1];
    }

    if (widgetImages[currentImageEdit][2] != null) {
        $("image_carousel_title").value = widgetImages[currentImageEdit][2];
    }
    ...
    if (widgetImages[currentImageEdit][4] != null) {
        $("image_carousel_description").value = widgetImages[currentImageEdit][4];
    }
    if (widgetImages[currentImageEdit][5] != null) {
        $("image_carousel_button").value = widgetImages[currentImageEdit][5];
    }
    if (widgetImages[currentImageEdit][6] != null) {
        $("image_carousel_align").value = widgetImages[currentImageEdit][6];
    }
    if (widgetImages[currentImageEdit][7] != null) {
        $("image_carousel_slide_title").value = widgetImages[currentImageEdit][7];
    }
    if (widgetImages[currentImageEdit][8] != null) {
        $("image_carousel_button_hide").value = widgetImages[currentImageEdit][8];
    }
...
function saveWidgetImage ()
{
    ...
    if ($("image2_carousel_image").value == '') {
        alert('Please select an image.');
        return;
    }
    ...
    if (currentImageEdit == -1) {
        widgetImages.push(new Array($("image_carousel_image").value, $("image2_carousel_image").value, $("image_carousel_title").value, $("image_carousel_link").value, $("image_carousel_description").value, $("image_carousel_button").value, $("image_carousel_align").value, $("image_carousel_slide_title").value, $("image_carousel_button_hide").value));
        ...
        widgetImages[currentImageEdit][1] = $("image2_carousel_image").value;
        widgetImages[currentImageEdit][2] = $("image_carousel_title").value;
        widgetImages[currentImageEdit][3] = $("image_carousel_link").value;
        widgetImages[currentImageEdit][4] = $("image_carousel_description").value;
        widgetImages[currentImageEdit][5] = $("image_carousel_button").value;
        widgetImages[currentImageEdit][6] = $("image_carousel_align").value;
        widgetImages[currentImageEdit][7] = $("image_carousel_slide_title").value;
        widgetImages[currentImageEdit][8] = $("image_carousel_button_hide").value;
...
function addImageRow (ImageID, ImageObj)
{
    ...
    aLink.innerHTML = ImageObj[7];
    aLink.title = ImageObj[7];
    ...
    for (var wImage in widgetItems[activeWidget].settings) {
        if (wImage.indexOf("image") >= 0 && wImage.indexOf("slide_title") >= 0) {
            ...
            widgetImages.push(new Array(
                ...
                widgetItems[activeWidget].settings[wImage.replace(/slide_title/gi, "image2Src")],
                ...
                position,
                widgetItems[activeWidget].settings[wImage.replace(/slide_title/gi, "button_hide")]
            ));
        }
    }
...
function commitwidgetImages ()
{
    ...
    for (var i = 0; i < widgetImages.length; i++) {
        if (widgetImages[i][0] != undefined) {
            ...
            widgetItems[activeWidget].settings["image" + i + "image2Src"] = widgetImages[i][1];
            widgetItems[activeWidget].settings["image" + i + "title"] = widgetImages[i][2];
            widgetItems[activeWidget].settings["image" + i + "link"] = widgetImages[i][3];
            widgetItems[activeWidget].settings["image" + i + "description"] = widgetImages[i][4];
            widgetItems[activeWidget].settings["image" + i + "button"] = widgetImages[i][5];
            widgetItems[activeWidget].settings["image" + i + "align"] = widgetImages[i][6];
            widgetItems[activeWidget].settings["image" + i + "slide_title"] = widgetImages[i][7];
            widgetItems[activeWidget].settings["image" + i + "button_hide"] = widgetImages[i][8];
        }
    }

    $("image_carousel_image").parentNode.removeChild($("image_carousel_image"));
    $("image2_carousel_image").parentNode.removeChild($("image2_carousel_image"));
    ...
    $("image_carousel_button_hide").parentNode.removeChild($("image_carousel_button_hide"));
