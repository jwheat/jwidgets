<?php
    ...
    */
    ...
    if ('%PARAM_SITE_URL%' != '' && '%PARAM_SITE_URL%' != '%PARAM_SITE_URL'.'%') {
            $param_site_url = '%PARAM_SITE_URL%';
    }
    ...
    if ('%PARAM_CLASS%' != '' && '%PARAM_CLASS%' != '%PARAM_CLASS'.'%') {
...
?>
        <li><a class='<?php print $param_class;?>' title="<?php print encodeHtml($widgetLink[0]); ?>" href="<?php
