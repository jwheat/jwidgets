...
function saveWidgetImage ()
{
    ...
    if (currentImageEdit == -1) {
        widgetImages.push(new Array($("image_carousel_image").value, $("image_carousel_title").value, $("image_carousel_link").value, $("image_carousel_description").value, $("image_carousel_button").value, $("image_carousel_align").value, $("image_carousel_slide_title").value));
