<?php
    /**************************************************
    * Messiah College Dynamic Dropdown Widget
    * Screen : Front End
    *
    */
...
<?php
    ...
    <?php if ($content != "") { ?>
        <div class="blueBG-text"><?php print $content;?></div>
    <?php }
...
?>
    <select class="select-area" onchange="selectURL(this)">
...
?>
        "><?php print encodeHtml($widgetLink[0]); ?></option>
