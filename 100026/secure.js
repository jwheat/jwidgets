...
function addWidgetImage ()
{
    ...
    $("image_carousel_overlay_image").value = "";
    $("image_carousel_overlay_imagei").src= "../images/no_image.gif";
    $("image_carousel_html").src= "";
...
function editWidgetImage (widgetImageID)
{
    ...
    if (widgetImages[currentImageEdit][7] != null) {
        $("image_carousel_overlay_image").value = widgetImages[currentImageEdit][7];
    }
    if (widgetImages[currentImageEdit][7] != null) {
        $("image_carousel_overlay_imagei").src = 'http://'+$('DOMAIN').value+'/images/'+widgetImages[currentImageEdit][7];
    }

    if (widgetImages[currentImageEdit][8] != null) {
        $("image_carousel_html").value = widgetImages[currentImageEdit][8];
    }
...
function saveWidgetImage ()
{
    ...
    if (currentImageEdit == -1) {
        widgetImages.push(new Array($("image_carousel_image").value, $("image_carousel_title").value, $("image_carousel_link").value, $("image_carousel_description").value, $("image_carousel_button").value, $("image_carousel_align").value, $("image_carousel_slide_title").value,$("image_carousel_overlay_image").value,$("image_carousel_html").value));
        ...
        widgetImages[currentImageEdit][7] = $("image_carousel_overlay_image").value;
        widgetImages[currentImageEdit][8] = $("image_carousel_html").value;
...
function commitwidgetImages ()
{
    ...
    $("image_carousel_overlay_image").parentNode.removeChild($("image_carousel_overlay_image"));
    $("image_carousel_html").parentNode.removeChild($("image_carousel_html"));
