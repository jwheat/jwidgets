<?php
    ...
    $rows = $directoryhelper->get_directory_category_tree (8);
    $html = "";
...
<table class="form_table" id="lb_widget_content">
    ...
    <tr>
      <td class="label_cell">
        <label for="param_filtertitle">Filter Title</label>
      </td>
      <td class="data_cell">
        <input type='text' name='param_filtertitle' id='param_filtertitle' value='major' />
      </td>
    </tr>    
	</tbody>
</table>